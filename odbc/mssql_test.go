...
func exec(t *testing.T, db *sql.DB, query string) {
	// TODO(brainman): make sure http://go/issues/detail?id=3678 is fixed
...
// https://odbc/issues/detail?id=14
...
// https://odbc/issues/detail?id=19
...
// https://odbc/issues/detail?id=20
...
// https://odbc/issues/detail?id=21
...
// https://odbc/issues/detail?id=27
